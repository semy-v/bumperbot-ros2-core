...
class WheelController {
 public:
    ...
    void configure(const double pid_control_rate, const WheelConfig& wheel_config);
    ...
    QuadratureEncoder& encoder() { return encoder_; }

    void setTargetVelocity(double rad_per_sec) { target_velocity_ = rad_per_sec; }
